...
local hold = require(game.ReplicatedStorage.Handler.EntityHandler.EntityHolder)
...
local EntityUpdater = require(game.ReplicatedStorage.Handler.EntityHandler.Updater)
EntityUpdater.Init()
...
local EntityContainer = require(game.ReplicatedStorage.Handler.EntityHandler.EntityContainerManager)
